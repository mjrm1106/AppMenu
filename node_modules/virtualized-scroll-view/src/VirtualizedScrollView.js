...
class VirtualizedScrollView extends React.PureComponent {
  ...
  // https://github.com/facebook/react-native/issues/27483
  updateViewLayouts = () => {
    console.log('trigger updateViewLayouts');
    const limiter = new Bottleneck({
      maxConcurrent: 500,
    });
    const updateLayout = Platform.OS === 'web' ? this.updateLayout : limiter.wrap(this.updateLayout);
    console.log('all refs', Object.keys(this.virtualizedViewRefMap));
    Promise.all(
  ...
  onContentSizeChange = (contentWidth, contentHeight) => {
    ...
    if (prevContentWidth !== 0 || prevContentHeight !== 0) {
      console.log('not trigger updateViewLayouts from onContentSizeChange');
  ...
  onLayout = (event) => {
    ...
    console.log('trigger updateViewLayouts from onLayout');
    this.updateViewLayouts();
